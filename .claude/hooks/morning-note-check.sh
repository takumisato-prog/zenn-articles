...
while IFS='|' read -r file title; do
  ...
  echo "========================================"
  echo ""
  echo "STEP 1. 以下のURLを開く"
  echo "        https://note.com/notes/new"
  echo ""
  echo "STEP 2. タイトル欄に貼り付け"
  echo "        $title"
  echo ""
  echo "STEP 3. 本文欄に下の「---本文ここから---」以降をコピペ"
  echo ""
  echo "STEP 4. 画面右上の「公開設定」をクリック"
  echo "        → 価格: 無料"
  echo "        → 「公開する」ボタンを押す"
  echo ""
  echo "STEP 5. 投稿後に Claude Code へ「投稿した」と伝える"
  echo ""
  echo "========================================"
  echo "---本文ここから---"
