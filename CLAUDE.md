...
## 会社名
**Altus（アルタス）**
ラテン語で「高み・頂点」。クライアントのビジネスを、AIの力で最高水準へ引き上げる。
...
| 広告素材 | `ad-creative` | バナー・SNS画像・動画構成・AI CM制作 |
...
| 役職 | スキル名 | 担当 |
|-----|---------|------|
| 部門長 | `web-production-lead` | 要件定義・工程管理・Figmaレビュー |
| デザイン | `figma-specialist` | Figmaデザイン・デザインシステム・UIシステム構築 |
| 実装 | `hp-developer` | コーディング・レスポンシブ・アニメーション |
...
| `/x-auto-post` | X自動投稿 | `/x-auto-post` → Xへの投稿・自動投稿管理 |
...
| 「CMを作りたい」「AI動画広告を作りたい」「SNS広告動画」 | ad-creative |
| 「プレスリリース」「SNS投稿」「PR TIMES」 | PR・SNS |
| 「Xに投稿して」「ツイートして」「X自動投稿」 | X自動投稿 |
